...
Un detalle de la propuesta de trabajo y la preparación de archivos puede encontrarse en el [manual](manual/instructivo (versión anterior).pdf). Para generar los archivos finales debe correr el [código dosponible en la carpeta ./scripts](script/).
