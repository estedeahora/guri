...
Es importante considerar que la propuesta editorial tiene como base diferenciar los tres grandes bloques que componen un artículo científico (ver estandar [XML-JATS](#0)), a saber:
...
Para ilustrar la organización de archivos prevista, si el artículo que se está corrigiendo corresponde al `Número 20` de la revista, entonces la carpeta del segundo artículo de la sección "3" (`./art302`) deberá tener la estructura de archivos que se presenta en la @fig-folder.
